...
intersect.mutant <- intersect(inc1.genename, waked2.genename)
...
out.data <- read.rpkm[intersect.mutant,]
write.table(out.data, file = "circadian_setdiff_inc_wake.txt", quote = FALSE, row.names = TRUE)
